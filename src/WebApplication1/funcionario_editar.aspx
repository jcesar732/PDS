...
<br />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:PDSI_2017_Julio_TrindadeConnectionString %>" SelectCommand="SELECT [nome], [telefone], [identidade], [carteiraDeTrabalho], [motorista], [tecnico] FROM [Funcionario] WHERE ([codigo] = @codigo)">
        <SelectParameters>
